...
Our evaluation on the test split shows that the baseline TF-IDF + Logistic Regression model achieves a classification accuracy of 0.636 and macro-F1 of 0.601. The fine-tuned DistilBERT transformer outperforms this baseline, achieving an accuracy of 0.715 and macro-F1 of 0.684, with nonoverlapping 95% bootstrap confidence intervals. We conclude that while the TF-IDF pipeline remains valuable for its computational efficiency and interpretability, the deep contextual representations captured by DistilBERT are critical for modeling the nuanced and complex emotional expressions characteristic of social media communication.
